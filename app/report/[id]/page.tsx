...
const reportCopy: Record<SupportedLanguage, ReportCopy> = {
  english: {
    ...
    patternsTitle: "Relationship Patterns",
    patternsDescription: (senderName) =>
      senderName
        ? `Categories that ${senderName} falls under based on ${englishPossessive(senderName)} responses.`
        : "Categories that your partner falls under based on their responses.",
    fromAnswers: (senderName) =>
      `From ${senderName ? `${englishPossessive(senderName)} answers` : "their answers"}`,
    ideasTitle: "Ideas that might help",
    ideasDescription: (senderName) =>
      senderName
        ? `How you should show up in ways that fit with what ${senderName} shared.`
        : "How you should show up in ways that fit with what they shared.",
    doTitle: "Things that often land well",
    avoidTitle: "Where friction can stack up",
    tenseTitle: "When things feel tense",
    loveTitle: (senderName) =>
      `Ways love tends to show up for ${senderName || "them"}`,
